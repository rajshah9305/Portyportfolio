...
import { Mail, Terminal, Cpu, Code, CheckCircle2 } from 'lucide-react';
import {
  Scanline,
  ParallaxGrid,
  ScrollProgress,
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900 font-sans overflow-x-hidden relative">
      <Scanline />
      <ParallaxGrid />
      <ScrollProgress />
      ...
      <main>
        ...
        {/* FOOTER / CONTACT */}
        <footer className="bg-zinc-900 text-zinc-50 py-24">
          <div className="container mx-auto px-6 md:px-12">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer" 
                      className="font-mono text-white hover:text-orange-500 transition-colors"
                    >
                      GitHub
                    </a>
                    <a 
            ...
            <div className="pt-8 border-t border-zinc-800 flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="label-mono text-zinc-500">
                © 2024 Raj Shah. All rights reserved.
              </p>
              <p className="label-mono text-zinc-500">
