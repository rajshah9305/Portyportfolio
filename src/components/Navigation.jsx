...
export const Navigation = ({ onScrollToTop }) => {
  ...
  return (
    <>
            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <a 
                  ...
                  className={`relative px-6 py-2.5 rounded-full font-mono text-[11px] font-bold tracking-widest transition-all duration-300 flex items-center gap-2 group ${
                    isActive 
      ...
      {/* Mobile Menu */}
      <div 
        className={`fixed inset-0 z-40 bg-zinc-50/90 backdrop-blur-xl transition-transform duration-500 ease-out-expo lg:hidden ${
